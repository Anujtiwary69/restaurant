...
class _OrderReviewScreenState extends State<OrderReviewScreen> {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  RatingBar(
                                    ...
                                    emptyColor:
                                        Color(Constants.color_lightgray),
  ...
  void callShareAppFeedback(double rate) {
    Map body = {
      'rate': rate.toString(),
      'comment': _text_comment.text,
      'image': _listBase64String,
      'order_id': widget.orderId,
      'contact': _text_contactNo.text,
    };
    RestClient(Retro_Api().Dio_Data()).add_review(body).then((response) {
